...
use crate::{
    ...
    mailbox::{
        ...
        Response, MboxBuffer, StashMeasurementReq,
    },
    CaliptraApiError,
};
...
pub trait SocManager {
    ...
    fn try_mbox_receive<'m, 'r> (&'m mut self, mut data: MboxBuffer<'r>) -> Result<Option<MailboxRecvTxn<'m, 'r, Self>>, CaliptraApiError>
    where
        Self: Sized,
        Self: 'm
    {
